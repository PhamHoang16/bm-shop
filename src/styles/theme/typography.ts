...
export const typography = {
  fontFamily:
    'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
  ...
  h2: { fontSize: '2.5rem', fontWeight: 500, lineHeight: 1.2 },
  h3: { fontSize: '2rem', fontWeight: 500, lineHeight: 1.2 },
